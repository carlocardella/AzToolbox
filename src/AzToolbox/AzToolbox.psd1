...
@{
    ...
    FunctionsToExport    = 'Add-AzServicePrincipalCertificate', 
    'Disable-AzKeyVaultCertificateAutorotation', 
    'Enable-AzKeyVaultCertificateAutorotation', 
    'Enable-AzKeyVaultSoftDelete', 'Export-AzKeyVaultCertificate', 
    'Get-AzClientCertificate', 'Get-AzCliReleaseAsset', 
    'Get-AzKeyVaultExpiringCertificate', 
    'Get-AzResourceProviderApiVersion', 
